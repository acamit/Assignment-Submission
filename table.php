...
$q1 = "CREATE TABLE IF NOT EXISTS `classes` (
  `class_id` varchar(8) NOT NULL,
  `class` varchar(50) NOT NULL,
  `dept_id` int(3) NOT NULL
)";

$q2 = "INSERT INTO `classes` (`class_id`, `class`, `dept_id`) VALUES
('BT101', 'B.Tech', 101),
('BT102', 'B.Tech', 102),
('MC101', 'M.C.A', 101)";
if(mysql_query($q1) ){
	echo 'classes table created.<br/>';
}
 if(mysql_query($q2)){
	echo 'data added into classes <br/>' ;
}

$q3 = "CREATE TABLE `departments` (
`dept_id` int(3) NOT NULL,
  `department` varchar(50) NOT NULL
)";

$q4 = "INSERT INTO `departments` (`dept_id`, `department`) VALUES
...
if(mysql_query($q3) ){
	...
	echo 'data added into departments <br/>' ;
}

$q5 = "CREATE TABLE IF NOT EXISTS `students` (
...
$q6 = "INSERT INTO `students` (`roll no`, `name`, `password`, `class_id`, `section`) VALUES
...
if(mysql_query($q5) ){
	...
	echo 'data added into students <br/>' ;
}

$q7 = "CREATE TABLE IF NOT EXISTS `subjects` (
...
$q8 = "INSERT INTO `subjects` (`sub_id`, `subject`, `teacher_id`, `class_id`, `semester`) VALUES
...
if(mysql_query($q7) ){
	...
	echo 'data added into subjects<br/>' ;
}

$q9 = "CREATE TABLE `submissions` (
...
if(mysql_query($q9) ){
	echo 'submissions table created.<br/>';
}

$q10 = "CREATE TABLE IF NOT EXISTS `teachers` (
  `id` varchar(5) NOT NULL,
  `teacher` varchar(30) NOT NULL,
  `dept_id` varchar(5) NOT NULL,
  `password` varchar(32) NOT NULL
)";
$q11 = "INSERT INTO `teachers` (`id`, `teacher`, `dept_id`, `password`) VALUES
...
if(mysql_query($q10) ){
	...
	echo 'data added into teachers<br/>' ;
}

$q12 = "CREATE TABLE IF NOT EXISTS `topics` (
  `topic_id` varchar(10) NOT NULL,
...
$q13 = "ALTER TABLE `classes`
 ADD PRIMARY KEY (`class_id`)
";
$q14 = "ALTER TABLE `departments`
 ADD PRIMARY KEY (`dept_id`)";
 
$q15 = "ALTER TABLE `students`
 ADD PRIMARY KEY (`roll no`)";
 $q16 = "ALTER TABLE `subjects`
 ADD PRIMARY KEY (`sub_id`,`class_id`)";
 
 $q17 = "ALTER TABLE `submissions`
 ADD PRIMARY KEY (`id`)";
 $q18 = "ALTER TABLE `teachers`
 ADD PRIMARY KEY (`id`)";
 $q19 = "ALTER TABLE `topics`
 ADD PRIMARY KEY (`topic_id`,`sub_id`,`class_id`)";
 $q20 = "ALTER TABLE `departments`
MODIFY `dept_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1";

if(mysql_query($q13) && mysql_query($q14) && mysql_query($q15) && mysql_query($q16) && mysql_query($q17) && mysql_query($q18) && mysql_query($q19) && mysql_query($q20) ){
